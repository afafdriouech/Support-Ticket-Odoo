...
class ResPartnerTicket(models.Model):
    ...
    support_ticket_ids = fields.One2many('support.ticket', 'partner_id', string="Tickets")
    ...
    def _count_new_support_tickets(self):
        ...
        opened_state = self.env['ir.model.data'].get_object('ticket-module', 'website_ticket_state_open')
